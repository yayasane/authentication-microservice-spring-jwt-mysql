...
public class JWTAuthorizationFilter extends OncePerRequestFilter{
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
        ...
        //J'autorise les méthodes suivantes pour les requêtes des pages proivenant d'autre domaine
        response.addHeader("Accesss-Control-Allow-Methods", "GET, POST, PUT, DELETE, PATCH");
        //Lorsque q'une page provenant d'un domaine x tente d'envoyer une requête vers une domaine y, le navigateur envoie d'abord une requête OPTIONS pour connaitre quels sont les autorizations pour les autres domaines dans ce domaine y.
